//------------------------------------------------------------------------------------------------//
//                                                                                                //
//                              H e a d P l a y i n g R e l a t i o n                             //
//                                                                                                //
//------------------------------------------------------------------------------------------------//
...
/**
 * Class <code>HeadPlayingRelation</code> represents the relation between a drum head and a
 * playing technique sign.
 *
 * @author Hervé Bitteur
 */
@XmlRootElement(name = "head-playing")
public class HeadPlayingRelation
        extends AbstractConnection
{
    ...
    {
        return constants.playingTargetCoeff.getValue();
    }
